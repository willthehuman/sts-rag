...
def answer_question(
    ...
    *,
    ...
    messages = [
        ...
        {"role": "user", "content": _build_user_prompt(question, exact, context, tool_context, web_results, web_error)},
    ]
    try:
...
def _local_answer(
    ...
    *,
    ...
    if tool_context and (tool_context.get("sections") or tool_context.get("notes")):
        lines = [local_tool_answer(tool_context, provider_error=provider_error)]
        if web_results:
